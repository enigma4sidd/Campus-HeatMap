...
#define CLIENTID "76428c2b87c0"                         // use K64F MAC address without colons
...
#define TOPIC "ZONE_2"                            // MQTT topic
...
//    data.password.cstring = PASSWORD;
   ...
   /* pc.printf("Subscribing to MQTT topic %s: ", topic);
    ...
    pc.printf("Subscribing to MQTT topic T_ZONE_2 ");
    if ((rc = client.subscribe("T_ZONE_2", MQTT::QOS0, messageArrived)) != 0)
        pc.printf("failed: rc= %d\r\n", rc);

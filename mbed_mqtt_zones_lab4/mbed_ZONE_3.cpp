...
#define CLIENTID "76428c2b87c3"                         // use K64F MAC address without colons
...
#define TOPIC "ZONE_3"                            // MQTT topic
...
//    data.password.cstring = PASSWORD;
   ...
   /* pc.printf("Subscribing to MQTT topic %s: ", topic);
    ...
    pc.printf("Subscribing to MQTT topic T_ZONE_3 ");
    if ((rc = client.subscribe("T_ZONE_3", MQTT::QOS0, messageArrived)) != 0)
        pc.printf("failed: rc= %d\r\n", rc);
